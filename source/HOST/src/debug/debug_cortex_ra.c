...
int cortex_ra_ocd(void)
{
	...
	memory[i++]=0xc5;	memory[i++]=0x80;	memory[i++]=0x00;	memory[i++]=0x00;		memory[i++]=0x02;		//DBG access enable, 16bits
	e=prg_comm(0x9d,i,0,0,ROFFSET,0,0,0,i/5);
	return e;
}


int cortex_ra_dbg(void)
{
	int i,e;

	// CSW = 0x80000002
	i=0;
	memory[i++]=0x8d;	memory[i++]=0x00;	memory[i++]=0x00;	memory[i++]=0x00;		memory[i++]=0x00;		//SEL = APB-AP
	memory[i++]=0xc5;	memory[i++]=0x80;	memory[i++]=0x00;	memory[i++]=0x00;		memory[i++]=0x02;		//DBG access enable, 16bits
	e=prg_comm(0x9d,i,0,0,ROFFSET,0,0,0,i/5);
	return e;
}
...
void show_cortex_ra_registers(void)
{
	int i;		
...
void debug_armcortex_ra(int mode)
{
	int errc,blocks,i,j;
		...
		do
		{
			...
			if(i>1)
			{
				...
				if((strstr(dbg_line,"c")-dbg_line) == 0)
				{
					...
					errc=prg_comm(0x23b,0,100,0,0,0,0,0,0x10);		// halt	
					show_cortex_ra_registers();	
				}
				...
				{	
					...
					{				
						...
						{				
							...
							printf("\r");show_cortex_ra_registers();			
						}	
					}			
				}			
