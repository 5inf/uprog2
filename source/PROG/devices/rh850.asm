...
rh850_init:		mov	r21,r17
			...
			ldi	ZH,0
			call	wait_ms
			sbi	CTRLPORT,RH850_RESET		;set RESET with FLMD0=1
			ldi	ZL,5
			ldi	ZH,0
			call	wait_ms
...
rh850_setfreq_data:	.db	0x09,0x32, 0x00,0x7A,0x12,0x00, 0x03,0xd0,0x90,0x00, ;8M -> 64M
			.db	0x09,0x32, 0x00,0xB7,0x1B,0x00, 0x03,0xd0,0x90,0x00, ;12M -> 64M
			.db	0x09,0x32, 0x00,0xF4,0x24,0x00, 0x03,0xd0,0x90,0x00, ;16M -> 64M
			.db	0x09,0x32, 0x01,0x31,0x2D,0x00, 0x03,0xd0,0x90,0x00, ;20M -> 64M
			.db	0x09,0x32, 0x01,0x6E,0x36,0x00, 0x03,0xd0,0x90,0x00, ;24M -> 64M
			.db	0x09,0x32, 0x00,0x00,0x00,0x00, 0x03,0xd0,0x90,0x00, ;int -> 64M
		
			.db	0x09,0x32, 0x00,0x7A,0x12,0x00, 0x04,0xc4,0xb4,0x00, ;8M -> 80M
			.db	0x09,0x32, 0x00,0xB7,0x1B,0x00, 0x04,0xc4,0xb4,0x00, ;12M -> 80M
			.db	0x09,0x32, 0x00,0xF4,0x24,0x00, 0x04,0xc4,0xb4,0x00, ;16M -> 80M
			.db	0x09,0x32, 0x01,0x31,0x2D,0x00, 0x04,0xc4,0xb4,0x00, ;20M -> 80M
			.db	0x09,0x32, 0x01,0x6E,0x36,0x00, 0x04,0xc4,0xb4,0x00, ;24M -> 80M
			.db	0x09,0x32, 0x00,0x00,0x00,0x00, 0x04,0xc4,0xb4,0x00, ;int -> 80M

;			.db	0x09,0x32, 0x00,0x7A,0x12,0x00, 0x09,0x89,0x68,0x00, ;8M -> 160M
;			.db	0x09,0x32, 0x00,0xB7,0x1B,0x00, 0x09,0x89,0x68,0x00, ;12M -> 160M
;			.db	0x09,0x32, 0x00,0xF4,0x24,0x00, 0x09,0x89,0x68,0x00, ;16M -> 160M
;			.db	0x09,0x32, 0x01,0x31,0x2D,0x00, 0x09,0x89,0x68,0x00, ;20M -> 160M
;			.db	0x09,0x32, 0x01,0x6E,0x36,0x00, 0x09,0x89,0x68,0x00, ;24M -> 160M
;			.db	0x09,0x32, 0x00,0x00,0x00,0x00, 0x09,0x89,0x68,0x00, ;int -> 160M
...
;------------------------------------------------------------------------------
; AREA ERASE
; PAR4 = Area (0x0 = Code 1, 0x10 user boot 0x20 data)
;------------------------------------------------------------------------------
rh850_aerase:		rcall	rh850_send_soh		;SOH senden
			ldi	XL,0x00			;LENH
			rcall	rh850_sendbyte
			ldi	XL,0x02			;LENL
			rcall	rh850_sendbyte
			ldi	XL,0x50			;area erase command
			rcall	rh850_sendbyte
			mov	XL,r19			;area select
			rcall	rh850_sendbyte		
		;	push	r16
			rcall	rh850_send_csum
			rcall	rh850_send_etx		;ETX senden
...
; PAR4=ETX/ETB
;------------------------------------------------------------------------------
rh850_skip_blockx:	movw	r24,r16
			mov	r6,r18
			mov	r18,r19
			adiw	r24,1
			call	api_resetptr
...
; set OTP
;------------------------------------------------------------------------------
rh850_otp_set:		call	api_resetptr
			rcall	rh850_send_soh		;SOH senden
			ldi	XL,0x00			;LENH
			rcall	rh850_sendbyte
			ldi	XL,0x63			;LENL
			rcall	rh850_sendbyte
			ldi	XL,0x2D			;otp set command
			rcall	rh850_sendbyte
			
			ldi	r24,0x62
rh850_otp_set_1:	call	api_buf_bread
			rcall	rh850_sendbyte
			dec	r24
			brne	rh850_otp_set_1
...
; get OTP
;------------------------------------------------------------------------------
rh850_otp_get:		call	api_resetptr
			rcall	rh850_send_soh		;SOH senden
			ldi	XL,0x00			;LENH
			rcall	rh850_sendbyte
			ldi	XL,0x01			;LENL
			rcall	rh850_sendbyte
			ldi	XL,0x2E			;get OTP command
			rcall	rh850_sendbyte
			rcall	rh850_send_csum
			rcall	rh850_send_etx		;ETX senden
...
;------------------------------------------------------------------------------
; set OTP
; r18 = FLASH2 number (*8, 0=none)
; r19 = EXT USER AREA (*8, 0=not)
;------------------------------------------------------------------------------
rh850_set_otp:		rcall	rh850_send_soh		;SOH senden
			ldi	XL,0x00			;LENH
			rcall	rh850_sendbyte
			ldi	XL,0x63			;LENL
			rcall	rh850_sendbyte
			mov	XL,r19			;Oset command
			rcall	rh850_sendbyte
			...
			ldi	r24,96
rh650_set_otp_1:	ldi	XL,0xff
			rcall	rh850_sendbyte
			dec	r24
			brne	rh650_set_otp_1
			mov	XL,r18
			rcall	rh850_sendbyte
